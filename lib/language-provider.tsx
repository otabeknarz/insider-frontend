...
const translations = {
	en: {
		...
		// Spaces
		"spaces.title": "Spaces",
		"spaces.all": "All Tasks",
		"spaces.individual": "Individual Tasks",
		"spaces.teams": "Teams",
		"spaces.custom": "Custom Spaces",
		"spaces.default": "Default Spaces",
		"spaces.search_space": "Search space or team...",
		"spaces.no_spaces_found": "No spaces or teams found",
		"spaces.select_space": "Select space or team",
		...
		"teams.create_team": "Create Team",
		"teams.search_team": "Search teams",
		"teams.select_team": "Select Team",
		"teams.no_teams_found": "No teams found",
	...
	uz: {
		...
		// Spaces
		"spaces.title": "Maydonlar",
		"spaces.all": "Barcha vazifalar",
		"spaces.individual": "Shaxsiy vazifalar",
		"spaces.teams": "Jamoalar",
		"spaces.custom": "Maxsus maydonlar",
		"spaces.default": "Standart maydonlar",
		"spaces.search_space": "Maydon yoki jamoani qidirish...",
		"spaces.no_spaces_found": "Maydon yoki jamoa topilmadi",
		"spaces.select_space": "Maydon yoki jamoani tanlang",
		...
		"tasks.teamMembersOnly":
			"Faqat jamoa a'zolari bu vazifaga tayinlanishi mumkin",
		...
		"tasks.loadError":
			"Vazifalarni yuklashda xatolik yuz berdi. Iltimos, qayta urinib ko'ring.",
		...
		"tasks.saveError":
			"Vazifani saqlashda xatolik yuz berdi. Iltimos, qayta urinib ko'ring.",
		"tasks.updateError":
			"Vazifani yangilashda xatolik yuz berdi. Iltimos, qayta urinib ko'ring.",
		...
		"profile.actions_description":
			"Profil xavfsizligi va sessiyasini boshqarish",
		"profile.password": "Parol",
		"profile.secure": "Xavfsiz",
		"profile.password_description":
			"Hisobingizni xavfsiz saqlash uchun parolingizni o'zgartiring",
		...
		"profile.logout_warning":
			"Chiqish qilganingizda, ushbu qurilmadagi sessiyangiz yakunlanadi.",
		...
		"teams.createError":
			"Jamoani yaratishda xatolik yuz berdi. Iltimos, qayta urinib ko'ring.",
		"teams.view": "Ko'rish",
		"teams.owner": "Rahbar",
		...
		"teams.removeUserConfirmation":
			"Haqiqatan ham bu foydalanuvchini jamoadan olib tashlashni xohlaysizmi?",
		"teams.member": "A'zo",
		"teams.admin": "Admin",
		...
		"teams.taskBoardDescription":
			"Jamoa vazifalarini boshqarish va tartibga solish",
		"teams.viewTaskBoard": "Vazifalar Doskasini Ko'rish",
		"teams.goToTaskBoard": "Vazifalar Doskasiga O'tish",
		"teams.my_teams": "Mening jamoalarim",
		"teams.create_team": "Jamoa yaratish",
		"teams.search_team": "Jamoalarni qidirish",
		"teams.select_team": "Jamoani tanlang",
		"teams.no_teams_found": "Jamoalar topilmadi",
