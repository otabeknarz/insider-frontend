    ...
    <div className="py-2">
      <div className="px-3 py-2">
        ...
        <div className="space-y-1">
          ...
          {allSpace && (
            <Button
              variant={selectedSpace?.id === allSpace.id ? "secondary" : "ghost"}
          ...
          {individualSpace && (
            <Button
              variant={selectedSpace?.id === individualSpace.id ? "secondary" : "ghost"}
              className="w-full justify-start"
          ...
          {teamSpaces.length > 0 && (
            <>
              ...
              <h3 className="mb-1 px-4 text-sm font-medium">{t('spaces.teams')}</h3>
              <ScrollArea className="h-[120px]">
                <div className="space-y-1">
                  {teamSpaces.map((space) => (
                    <Button
                      key={space.id}
                      variant={selectedSpace?.id === space.id ? "secondary" : "ghost"}
                      className="w-full justify-start"
          ...
          {customSpaces.length > 0 && (
            <>
              <Separator className="my-2" />
              <h3 className="mb-1 px-4 text-sm font-medium">{t('spaces.custom')}</h3>
              <ScrollArea className="h-[120px]">
                <div className="space-y-1">
