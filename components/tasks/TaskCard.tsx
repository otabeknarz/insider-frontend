    ...
    >
      ...
      <div 
        className={cn(
          ...
          task.status === TaskStatusBackend.ASSIGNED ? "bg-yellow-400" : 
          task.status === TaskStatusBackend.IN_PROCESS ? "bg-blue-400" : 
          task.status === TaskStatusBackend.COMPLETED ? "bg-green-400" : 
          "bg-slate-300"
        )}
      />
